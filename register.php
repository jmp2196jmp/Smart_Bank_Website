		 ...
		 <table width="550" border="0" cellspacing="0" cellpadding="5" class="entryTable">
          ...
          <tr>
			...
			<span id="sprypwd"> 
			  ...
			  <span class="passwordMinCharsMsg">You must specify at least 10 characters.</span>
			  <span class="passwordMaxCharsMsg">You must specify at max 20 characters.</span>
			</span>
			</td>
          </tr>
		  ...
		  <tr>
            ...
            <td height="30" class="content">
			<span id="sprytf_phone1">
            <input name="phone" type="text" class="frmInputs" id="accno" size="20" maxlength="30" /><small> </small>
            <br/>
		  ...
		  <tr>
            ...
            <td height="30" class="content">
			<span id="sprytf_dob">
            <input name="dob" type="text" class="frmInputs" id="dob"  size="20" maxlength="30" />
            <br/>
		  ...
		  <tr>
            <td width="120" height="30" class="label"><label for="accno"><strong>Pin Code</strong></label></td>
            <td height="30" class="content">
			<span id="sprytf_zip">
            <input name="zipcode" type="text" class="frmInputs" id="accno" size="15" maxlength="30" />
            <br/>
            <span class="textfieldRequiredMsg">Pin Code is required.</span>
			</span>
			</td>
		  </tr>
...
//Password
var sprypass1 = new Spry.Widget.ValidationPassword("sprypwd", {minChars:10, maxChars: 20, validateOn:["blur", "change"]});
//Confirm Password
var spryconf1 = new Spry.Widget.ValidationConfirm("sprycpwd", "sprypwd", {minChars:10, maxChars: 20, validateOn:["blur", "change"]});
//Email ID
