...
<form action="<?php echo WEB_ROOT; ?>view/process.php?action=transfer" method="post" >
    <table width="550" border="0" cellpadding="5" cellspacing="1" class="entryTable">
	  ...
	  <tr>
        <td width="200" height="30" class="label"><strong>IFSC Code</strong></td>
        <td height="30" class="content">		
		<span id="sprytf_swift">
            <input name="swift" type="text" size="30" maxlength="30" />
            <br/>
            <span class="textfieldRequiredMsg">IFSC Code is required.</span>
			<span class="textfieldMinCharsMsg">IFSC Code specify at least 8 characters.</span>
			<span class="textfieldMaxCharsMsg">IFSC Code must specify at max 12 characters.</span>
	  ...
	  <tr>
        <td width="200" height="30" class="label"><strong>Amount to Transfer Rupees</strong></td>
        <td height="30" class="content">
		<span id="sprytf_amt">
...
var sprytf_swift = new Spry.Widget.ValidationTextField("sprytf_swift", 'none', {minChars:8, maxChars: 12, validateOn:["blur", "change"]});
