...
$_SESSION['otp_token']
-->
<p>The token code is : <?php echo $_SESSION['otp_token'];?>
<p>You have <span id="defaultCountdown"></span> minutes remaining to insert valid OTP. System will automatically redirect to 'Bill Payment' page to initiate bill payment again.</p>

<form action="<?php echo WEB_ROOT; ?>view/process.php?action=token1" method="post">
    <table width="550" border="0" cellpadding="5" cellspacing="1" class="entryTable">
       <tr id="listTableHeader">
        <th colspan="2">Pay Bill</th>
      </tr>
      <tr>
...
$(document).ready(function(){ 
	function timerdone(){
		var webRoot = '<?php echo WEB_ROOT; ?>'+'view/?v=Bill';
