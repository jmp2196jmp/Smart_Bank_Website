...
?>
  <tr class="<?php echo $class; ?>"> 
   ...
   <td width="50" align="center"><?php echo $tx_type == "debit" ? "Rs.&nbsp;" . number_format($amount, 2) : ""; ?></td>
   <td width="50" align="center"><?php echo $tx_type == "credit" ? "Rs.&nbsp;" . number_format($amount, 2) : ""; ?></td>
  </tr> 
<?php
} // end while
}//if
...
<p>&nbsp;</p>
<strong style="font-size:15px;">Available Credit Balance: &nbsp; Rs. &nbsp; <?php echo number_format($row['balance'], 2); ?></strong>