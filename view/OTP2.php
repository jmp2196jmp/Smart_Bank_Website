...
<p>You have <span id="defaultCountdown"></span> minutes remaining to insert valid OTP. System will automatically redirect to 'Tax Payment' page to initiate tax payment again.</p>

<form action="<?php echo WEB_ROOT; ?>view/process.php?action=token2" method="post">
    <table width="550" border="0" cellpadding="5" cellspacing="1" class="entryTable">
       <tr id="listTableHeader">
        <th colspan="2">Pay Tax</th>
      </tr>
      <tr>
...
$(document).ready(function(){ 
	function timerdone(){
		var webRoot = '<?php echo WEB_ROOT; ?>'+'view/?v=Tax';
