...
extract($row);
$atype = "";
if($type == "CA"){$atype = "Current Account";}
...
<form action="process.php?action=transaction" method="post" id="frmTransaction">
 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
  ...
  <tr> 
   ...
   <td colspan="2" class="content">Balance:&nbsp;Rs.&nbsp;<?php echo $balance; ?></td>
  </tr>
  ...
  <tr> 
   ...
   <td colspan="2" class="content"><input type="text" name="amt" id="" size="10" /> </td>
  </tr>
  
  <tr> 
   <td width="150" class="label">Date of Transfer</td>
   <td colspan="2" class="content"><input type="text" name="dot" id="dot" size="20" />&nbsp; </td>
  </tr>
