...
//	$accno 	= (int)$_POST['accno'];
	...
	*/
	...
	$sql = "INSERT INTO tbl_address (user_id, address, city, state, zipcode, country) 
			VALUES ($insert_id, '$add', '$city', '$state', $zip, 'India')";
	dbQuery($sql);
	...
	This is to inform you that your Account # $accno is register successfully with Online Bank and currently in Inactive state. We will soon contact you once it get activate.<br/><br/>In case you need any further clarification for the same, please do get in touch with your Home Branch.<br/><br/>
