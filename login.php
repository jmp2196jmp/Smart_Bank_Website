  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="20">
    <tr> 
     <td class="contentArea">
      ...
      <h2 align="center"><strong>Login :</strong> Log in to Access your Account</h2>
         ...
         <td class="contentArea"> 
		  ...
		  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
           ...
           <tr class="text"> 
            ...
            <td width="10" >:</td>
            <td>
			<span id="sprytf_firstname" style="text-align:left;">
            <input name="fname" type="text" id="accno" tabindex="10" size="30" maxlength="30" />
            <br/>
		   ...
		   <tr>
             <td colspan="3">
			 If your account is not registered with us, please <a href="<?php echo WEB_ROOT; ?>register.php">Register it Now</a>.
			 </td>
          </tr>
          
           <tr>
             <td colspan="3" align="center">
			 Back to <a href="<?php echo WEB_ROOT; ?>web/main_index.php">Home</a>.
			 </td>
          </tr>
...
var sprypassword1 = new Spry.Widget.ValidationPassword("sprypassword1", {minChars:10, maxChars: 20, validateOn:["blur", "change"]});
//-->
</script>
</html>
